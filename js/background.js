var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/ferrari-enzo-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/ferrari-enzo-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/ferrari-enzo-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/ferrari-enzo-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Ferrari Enzo?",
				description: "Get awesome Ferrari Enzo HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
